...
// when pausing, dont increment time
var currentTime = 0.0;
...
function updateTargets(updateStart) {
	...
	for (var i = 0; i < count; i++) {
		...
		var radius =  window.devicePixelRatio * (window.innerHeight / 2 - 150 + Math.sin(angle * 4.1 + currentTime) * displace);
